<template>
    <div class="container-sell">
        ...
        <UserPageDetail v-if="showDetail" :modeAdd="modeAdd" @closePopup="closePopup"></UserPageDetail>
        <!-- Modal xác nhận xóa -->
...
import UserPageDetail from './StaffPageDetail.vue';
...
const viewProductDetail = async (userEdit) => {
    ...
    await store.dispatch('getUserByID', userEdit.UserID);
